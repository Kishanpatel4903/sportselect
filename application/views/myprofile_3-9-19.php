            ...
            <div class="row">
               ...
               <div class="col-md-12">
                  ...
                  <div class="tab-content mb-5" id="myTabContent">
                     <div class="tab-pane fade" id="mandate-old" role="tabpanel" aria-labelledby="profile-tab">
                        <div class="container-fluid">
                           <div class="row">
                                            ...
                                            <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
                                                ...
                                                <div class=" register-form needs-validation">
															  ...
															  <div class="col-md-12">
																 ...
																 <div class="form-row">
																	<div class="col-md-4 mb-3">
																	   ...
																	   <select id="territoryorsport" class="custom-select" required>
																		  <!-- <option value="AF">Worldwide </option> -->
																		  <option value="territory" <?php if(isset($mandate_check) AND $mandate_check->_Territory == 'territory' ){ echo "SELECTED"; } ?>>Territory </option>
                                                         <option value="club" <?php if(isset($mandate_check) AND $mandate_check->_Territory == 'club' ){ echo "SELECTED"; } ?>>Clubage </option>
																	   </select>
																	  
																	</div>
																	<div class="col-md-4 mb-3 selectterritorydiv">
																	   <label for="selectterritory">Select Territory</label>
																	   <select id="selectterritory" class="custom-select" required>
																	...
																	<div class="col-md-4 mb-3 selectclubdiv" style="display: none;">
																	   ...
																	   <select id="selectclub" class="custom-select" required>
																	...
																	<div class="col-md-4 mb-3">
																	   ...
																	   <input type="text" class="form-control" id="validationCustom02" value="<?php echo isset($mandate_check)?$mandate_check->_Term_athlete:""; ?>"  required>
																	   <div class="valid-feedback">
																		  Looks good!
																	   </div>
																	</div>
                                                   ...
                                                   <div class="col-md-4 mb-3 tutionfeediv" style="display: none;">
                                                       <label class="" for="tuitionfee">Tuition Fee</label>
                                                         <div class="input-group mb-2 mr-sm-2 mb-sm-0">
                                                           <div class="input-group-addon currency-symbol">$</div>
                                                   ...
                                                   <div class="col-md-4 mb-3">
                                                      ...
                                                      <span class="input-group-addon currency-addon">Months</span>
																	...
																	<div class="col-md-4 mb-3">
																	   ...
																	   <input type="text" name="agency_fee" class="form-control" id="validationCustom01" value="<?php echo isset($mandate_check)?$mandate_check->_Agency_fee:""; ?>"  required>
																	   <div class="valid-feedback">
																		  Looks good!
																	   </div>
																	</div>
																	<div class="col-md-4 mb-3">
																	   ...
																	   <input type="text" class="form-control" id="validationCustom02" value="<?php echo isset($mandate_check)?$mandate_check->_Extension_fee:""; ?>"   required>
																	   <div class="valid-feedback">
																		  Looks good!
																	   </div>
																	</div>
