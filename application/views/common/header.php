...
if(isset($navbar) AND $navbar=='player'){
  $currentuser = '1';
} 
elseif(isset($navbar) AND $navbar=='agent'){
  $currentuser = '2';  
}
//echo $currentuser; exit;
$noticount = $this->model->get_notificationcount($this->session->userdata('currentuser'));
$notifications = $this->model->get_notification($this->session->userdata('currentuser'));    
      ...
      select: function (a, b) {
        ...
        jQuery.ajax({
          ...
          success: function (data) {
            ...
            else if(data.type == 'agent' && currenttype == '1'){

               window.location = "<?php echo base_url().'agent' ?>/"+data.id;;
            }
  ...
  <div class="maincontainer ">
    <div class="leftsidebar ">
      ...
      <div class="profilepart">
        ...
        <div class="detailsofprofile">
         ...
         <p class="second">
            <?php
                ...
                //echo $currenttype=='1' ?$cuser->_PrimaryPosition:'';   if(!isset($cuser) ){ echo "Position"; } ?> 
        </p> 
        ...
        <div class="mt-2  mb-none mdm-none">
          <?php 
        if($currenttype == '1')
        {
            $completelink =base_url('myprofile/editprofile'); 
        }
        elseif($currenttype == '2'){
            $completelink =base_url('agent-edit-profile');
        }elseif($currenttype == '3'){
            $completelink=base_url('club-edit-profile');
        }
            ?>
    <a href="<?php echo $completelink; ?>" style="text-decoration: none;color: #000;">
        <p class="mb-0" style="font-size: 13px">Completed Profile </p>
            <div class="progress">
            <?php
            $profileper = 0;
            if($currenttype=='1'){
                //$profileper = 0;
                //echo "<pre>"; print_r($cuser);
                if($cuser->_Photo!=''){
                    $profileper=$profileper+20;
                }
                if($cuser->_Heigth != '' && $cuser->_Weight != '' && $cuser->_Living != '' && $cuser->_User_language != '' && $cuser->_SpokenLanguage != '' && $cuser->_FamilyStatus != '' && $cuser->_Outfitter != '' && $cuser->_ShoesSize !='' && $cuser->_Dob !='0000-00-00' ){
                    $profileper=$profileper+20;    
                }
 
                if($cuser->_PreferedSide !='' && $cuser->_PrimaryPosition !='' && $cuser->_AlternatePosition !='' && $cuser->_AgentName !='' && $cuser->_PlacingAgent !='' && $cuser->_Salary !='' && $cuser->_JerseyNumber !='' && $cuser->_LastContractdate !='0000-00-00'  && $cuser->_Academy !=''  && $cuser->_Offeraccept !='' && $cuser->_Ijuries !='' && $cuser->_StatisticsLink !='' ){
                    $profileper=$profileper+20;    
                     
                }
                if($cuser->_Other !='' && $cuser->_First_availability !='' && $cuser->_Second_availability !='' && $cuser->_Reference !='' ){
                    $profileper=$profileper+20;
                }   
            }
            if($currenttype=='2'){
                if($cuser->_Photo!=''){
                    $profileper=$profileper+33;
                }
                if($cuser->_Age!='' && $cuser->_Totaldeal!='' && $cuser->_Education!='' && $cuser->_Experience!='' && $cuser->_Agent_type!='' && $cuser->_Status!='' && $cuser->_Spoken_language!='' && $cuser->_Agency!='' && $cuser->_Agency_fee!='' && $cuser->_Nameof_private!='' && $cuser->_Agency_logo!='' && $cuser->_Certificate!='' && $cuser->_Certificate_name!='' && $cuser->_Scope!=''  && $cuser->_Info!='' ){
                    $profileper=$profileper+33;
                }
                if($cuser->_Bankname!='' &&  $cuser->_Iban!='' &&  $cuser->_Register_no!='' &&  $cuser->_Bank_address!=''){
                    $profileper=$profileper+33;
                }
            }
            //echo $profileper;
            ...
            ?>    
            <div class="progress-bar" role="progressbar" style="width: <?php echo $profileper; ?>%;" aria-valuenow="<?php echo $profileper; ?>" aria-valuemin="0" aria-valuemax="100"><?php echo $profileper; ?>%</div>
            </div>
    </a>
</div>
      </div>
         ...
         <nav class="navbar navbar-expand-sm">
              ...
              <div class="collapse navbar-collapse" id="navbarSupportedContent">
                   <ul class="navbar-nav mr-auto flex-column">
                     ...
                     <li class="nav-item">
                          <?php $reportlink = $currenttype=='1'?base_url().'player-report':base_url().'player-report/'.$playeridd; ?> 
                       <a class="nav-link" href="<?php echo $reportlink; ?>">
                     ...
                     <!-- <li class="nav-item">
                      ...
                      <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                          ...
                          <?php $mandatelink = $currenttype=='1'?base_url().'player-mandate':base_url().'player-mandate/'.$playeridd; ?>
                          <a class="dropdown-item" href="<?php echo $mandatelink; ?>">mandate offer</a>
                          <a class="dropdown-item" href="<?php echo base_url('mandate-histry'); ?>">mandate history</a>
                        </div>
                      </li>
                     <li class="nav-item">
                       <a class="nav-link" href="<?php echo base_url('player-characterstics'); ?>">
                         <i class="flaticon-checklist"></i> <span class="menunamespan">characterstics</span>
                       </a>
                     </li>
                     <li class="nav-item">
                       <a class="nav-link" href="<?php echo base_url('player-financial'); ?>">
             ...
             <ul class="navbar-nav mr-auto flex-column">
              ...
              <li class="nav-item dropdown">
               ...
               <li class="nav-item dropdown">
                 ...
                 <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                  <p class="sub-menu-header"> Mandate</p>
                  <?php  $mandatelink = $currenttype=='2'?base_url().'agent-mandate':base_url().'player-agent-mandate/'.$agentidd; ?>
                   <a class="dropdown-item" href="<?php echo $mandatelink; ?>">Mandate Offer </a>
                   <a class="dropdown-item" href="<?php echo base_url('mandate-histry'); ?>">Mandate History</a>
                 </div>
               </li>
          ...
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav mr-auto flex-column">
              ...
              <li class="nav-item dropdown">
                ...
                <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                  <p class="sub-menu-header">contract</p>
                  <a class="dropdown-item" href="#">first team</a>
                  <a class="dropdown-item" href="#">reserve team</a>
                  <a class="dropdown-item" href="#">17/18 years</a>
                  <a class="dropdown-item" href="#">15/16 years</a>
              ...
              <li class="nav-item dropdown">
                ...
                <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                  ...
                  <a class="dropdown-item" href="#">club partnership</a>
                  <a class="dropdown-item" href="#">offer players</a>
                  <a class="dropdown-item" href="#">transfer windows</a>
                </div>
              </li>
              <li class="nav-item dropdown">
                <a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                ...
                <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                  ...
                  <a class="dropdown-item" href="#">mandate history</a>
                </div>
              </li>
              <li class="nav-item">
                <a class="nav-link" href="#">
              ...
              <li class="nav-item dropdown">
                ...
                <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                  ...
                  <a class="dropdown-item" href="#">training grounds</a>
                  <a class="dropdown-item" href="#">city</a>
                  <a class="dropdown-item" href="#">living conditions</a>
      ...
      <div class="notificationtop">
        <li class="nav-item dropdown">
          <a href="#" class="nav-link" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
            ...
            <?php if($noticount>0){ ?><span class="notificationcount"><?php echo $noticount; ?></span><?php } ?>
          </a>
              ...
              <?php //echo "<h1>".$this->session->userdata('currentuser')."</h1>"; exit;
                 //print_r($notifications); exit;
                  if(!empty($notifications)){
                     ...
                     $current = $this->session->userdata('usertype');  
