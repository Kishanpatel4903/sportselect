                     ...
                     <div class="tab-pane fade" id="clubdetail-tab" role="tabpanel" aria-labelledby="clubdetail-tab">
                        <form action="<?php echo base_url().'Club_controller/profileupdate'; ?>" method="post" novalidate="true">
                           ...
                           <div class="row">
                              ...
                              <div class="col-sm-6">
                                 <div class="form-group">
                                    <label for="">Posision</label>
                                    
                                    <select name="position" class="form-control">
                                       <option value="">Select position</option>
                                       <option value="sports director" <?php if($data->_Position == 'sports director'){echo "SELECTED"; } ?>>sports director</option>
                                       <option value="coach" <?php if($data->_Position == 'coach'){echo "SELECTED"; } ?>>coach</option>
                                       <option value="Manager" <?php if($data->_Position == 'Manager'){echo "SELECTED"; } ?>>Manager</option>
                                    </select>
                                    <div class="help-block form-text with-errors form-control-feedback"></div>
                                 </div>
                              </div>
                              <div class="col-sm-6">
                                 <div class="form-group">
                                    ...
                                    <select name="tier" class="form-control">
                                       ...
                                       <option value="1st tier" <?php if($data->_Tier == '1st tier'){echo "SELECTED"; } ?>>1st tier</option>
                                       <option value="2nd tier" <?php if($data->_Tier == '2nd tier'){echo "SELECTED"; } ?>>2nd tier</option>
                                       <option value="3rd tier" <?php if($data->_Tier == '3rd tier'){echo "SELECTED"; } ?>>3rd tier</option>
                                       <option value="independent academy" <?php if($data->_Tier == 'independent academy'){echo "SELECTED"; } ?>>independent academy</option>
                                    </select>
                                    <div class="help-block form-text with-errors form-control-feedback"></div>
                                 </div>
                              </div>  
