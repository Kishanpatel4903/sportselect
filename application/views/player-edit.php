        ...
        <div class="element-wrapper">
          <div class="element-box">
            ...
            <div class="tab-content" id="myTabContent">
              <div class="tab-pane fade show " id="persion-tab" role="tabpanel" aria-labelledby="home-tab">
              ...
              <div class="tab-pane fade active show" id="about-tab" role="tabpanel" aria-labelledby="profile-tab">
                  ...
                  <div class="row">
                    <div class="col-sm-6">
                      <div class="form-group">
                        ...
                        <input class="form-control" name="dob" data-match-error="Enter Date of birth" placeholder="Enter Date of birth" required="required" type="date" value="<?= $data->_Dob!='0000-00-00'?date('Y-m-d',strtotime($data->_Dob)):''; ?>">
                        <div class="help-block form-text with-errors form-control-feedback"></div>
                      </div>
                    </div>
                    <div class="col-sm-6">
                      <div class="form-group">
                        ...
                        <input class="form-control" name="video" data-match-error="Enter video link" placeholder="Enter video link" required="required" type="text" value="<?= $data->_Video!=''?$data->_Video:''; ?>">
                        <div class="help-block form-text with-errors form-control-feedback"></div>
                      </div>
                    </div>
                  </div>
              ...
              <div class="tab-pane fade" id="career-tab" role="tabpanel" aria-labelledby="career-tab">
                ...
                <input type="hidden" name="tab" value="tab3">
                  ...
                  <div class="row">
                    <div class="col-sm-6">
                      <div class="form-group">
                        ...
                        <select class="form-control" name="prefer_side">
                  ...
                  <div class="row">
                    ...
                    <div class="col-sm-6">
                      <div class="form-group">
                        ...
                        <input class="form-control" data-match-error="Enter Date of birth" placeholder="Enter Contract End" required="required" type="date" id="contractend" name="contractend" value="<?= $data->_LastContractdate!='0000-00-00 00:00:00'?date('Y-m-d', strtotime($data->_LastContractdate)):''; ?>"   required>
                        <div class="help-block form-text with-errors form-control-feedback"></div>
                      </div>
                    </div>
                    <div class="col-sm-6">
                  ...
                  <div class="element-info mt-3">
                    <div class="element-info-with-icon">
                      <div class="element-info-text">
                        <h5 class="element-inner-header">Injuries</h5>
                      </div>
                    </div>
                  </div>
                  <div class="row">
                    <div class="col-sm-12">
                      <table width="100%" class="commontable mb-5">
                        <thead>
                          <tr>
                  ...
                  <div class="row">
                    ...
                    <div class="col-sm-6">
                      <div class="form-group">
                        <label for="">Time Of Recover</label>
                  ...
                  <div class="row">
                    ...
                    <div class="col-sm-6">
                      <div class="form-group">
                        <label for="">Injuries Documents</label>
                        <div class="custom-file" data-text="Select your file!">
                  ...
                  <div class="row">
                    <div class="col-sm-6">
                      <label for="" class="d-block">current status</label>
                      <button type="button" class="btn btn-sm switch btn-toggle" data-toggle="button" aria-pressed="false" autocomplete="off">
                        <div class="handle"></div>
                      </button>
                    </div>
