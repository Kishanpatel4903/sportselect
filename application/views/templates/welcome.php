        ...
        <td style="padding:20px 0 20px 0" align="center" valign="top">
              ...
              <tr>
                <td align="center" style="border:1px solid #E0E0E0;" bgcolor="#ffffff" valign="top">
                  <a href="<?php echo base_url(); ?>">
                    <!-- <img src="<?php echo $mailed_data['logo']; ?>" style="margin-bottom:5px;"  border="0" /> -->
                    <?php echo $mailed_data['logo'];  ?>
                  </a>
              </td>
              </tr>
            <tr>
                <td style="text-align: center;border-top:1px solid #E0E0E0;border-bottom:1px solid #E0E0E0;     border-left: 1px solid #e0e0e0; border-right: 1px solid #e0e0e0; background:#F3F3F3;"><span style="font-size: 26px; color:#333333;">Welcome to Sport Select</span></td>
              </tr>
            <tr>
         <td bgcolor="#ffffff" style="font-size:13px;line-height: 10px;border-left: 1px solid #e0e0e0;border-right: 1px solid #e0e0e0;">
          <p><strong>Dear <?php echo ucfirst($mailed_data['username']); ?>,</strong></p>
        	<p style="margin: 5px 5px;text-align: justify;line-height: 25px;">Thank you for registering into Sport Select.</p>
          ...
          <!-- <p style="margin: 5px 5px;text-align: justify;line-height: 25px;">Click <a target="_blank" href="<?php echo base_url('verifyemail/'.$mailed_data['verify_link']);?>">Here</a> to verify your email.</p> -->
            ...
            <tr><td align="center" bgcolor="#002664" style="border:1px solid #E0E0E0; font-size:12px; color:#ffffff; font-family:Verdana, Geneva, sans-serif;">Thank You,<b> Sport select</b></td></tr>
            <tr>
            </tbody>
          </table></td>
      </tr>
