...
<?php } ?>
               ...
               <div class="up-controls">
                  <div class="row">
                     ...
                     <div class="col-sm-9 text-right addfriends">
                        ...
                        <?php
                           if($profile->_StatisticsLink !=''){
                              $link = $profile->_StatisticsLink;
                           } else{
                              $link = base_url().'uploads/player/cv/'.$profile->_Cv;
                           }
                        ?>
                        <a target="_blank" class="btn btn-primary btn-sm" href="<?php echo $link; ?>">
                           <i class="fa fa-eye"></i>
                     ...
                     <div class="col-sm-3">
                        <div class="contryandclubname">
                           ...
                           <i class="fa fa-user-plus connections"> 0 Connections</i>
                           <?php
                  ...
                  <div class="m-b mt-5">
                     <div class="row m-b">
                        ...
                        <div class="col-lg-6">
                           <div class="row">
                              <div class="col-sm-6 b-r b-b b-t b-l">
                                 <div class="el-tablo centered padded">
                                    <div class="value">
                                       <?php
                                       if($profile->_Dob != '0000-00-00'){

                                       $dateOfBirth = date('d-m-Y',strtotime($profile->_Dob));// "17-10-1985";
                                       $today = date("Y-m-d");
                                       ...
                                       //echo $profile->_Dob!=''?$profile->_Age:'-'; ?>
                           ...
                           <div class="row">
                              ...
                              <div class="col-sm-6 b-r b-b">
                                 <div class="el-tablo centered padded" data-toggle="modal" data-target="#injuries-popup">
                        ...
                        if($profile->_Video != ''){ 
                         ?>
                           <div class="col-lg-6">
                              <iframe width="100%" height="100px" src="<?php echo $profile->_Video; ?>" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen style="min-height: 170px;"></iframe>
                           </div>
                     <?php } ?>
                     </div>
                     <!-- <div class="padded">
   ...
   <div class="profiledetailboxright">
      ...
      <?php }else{
         echo "<p>Producing agent not found. </p>";
      } ?>
         </div>
      </div>
      <div class="row row-eq-height">
...
<div class="modal fade themepopup" id="injuries-popup" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
      ...
      <div class="titledivmodel">
         <h4 class="bluetitleh4 text-center">INJURIES</h4>
      </div>
                    <ul class="nav nav-tabs clubpagetabnav" id="myTab" role="tablist">
                        <li class="nav-item"> <a class="nav-link active" id="profile-tab" data-toggle="tab" href="#localcup" role="tab" aria-controls="localcup" aria-selected="false">Present Injuries</a></li>
                        <li class="nav-item"> <a class="nav-link" id="profile-tab" data-toggle="tab" href="#localleague" role="tab" aria-controls="localleague" aria-selected="false">previous Injuries</a></li>
                    </ul>
                    <div class="tab-content" id="myTabContent">
                        <div class="tab-pane fade show active subtabintab" id="localcup" role="tabpanel" aria-labelledby="profile-tab">
                            <div class="row">
                                <div class="col-md-12">
                                    <table width="100%" class="commontable mt-5">
                                        <thead>
                                            <tr>
                                                <th>Type of Injuries</th>
                                                <th>time of recover</th>
                                                <th>expected date</th>
                                    <th>Action</th>
                                    <th>Document</th>
                                            </tr>
                                    ...
                                    <td><button class="attributebtn" ><i class="fa fa-download" aria-hidden="true"></i></button></td>
                                            </tr>
                                            <tr>
                                                <td>Type</td>
                                                <td>17-09-19</td>
                        ...
                        <div class="tab-pane fade subtabintab" id="localleague" role="tabpanel" aria-labelledby="profile-tab">
                            <div class="row">
                                <div class="col-md-12">
                                    <table width="100%" class="commontable mt-5">
                                        <thead>
