...
jQuery(function() {
    ...
    jQuery("#countrydropdown").prepend("<option value='' selected='selected'>Select country</option>");
...
jQuery("#usertype").change(function(){
    ...
    if(jQuery(this).val()=='3'){
        ...
        jQuery(".yourself").hide();
         ...
         jQuery(".tierdiv").show();
         jQuery(".statistiklinklbl").text('Web Link');
         jQuery("#statistiklink").attr('placeholder','Web Link');
        ...
        jQuery(".clubfield").hide();
            ...
            jQuery("#statistiklink").attr('placeholder','Statistics Link');
