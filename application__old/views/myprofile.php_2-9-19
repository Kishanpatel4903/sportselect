            ...
            <div class="row">
                              ...
                              <div class="maindivinfo">
                                 <div class="profileinfo">
                                    <table>
                                       ...
                                       <tr>
                                          <td>Agent name</td>
                                          <td><?php echo $refdata->_Firstname.' '.$refdata->_Lastname; ?></td>
                                       </tr>
                                       <tr>
               ...
               <div class="col-md-12">
                  <ul class="nav nav-tabs" id="myTab" role="tablist">
                     ...
                     <li class="nav-item">
                        <a class="nav-link" id="contact-tab" data-toggle="tab" href="#mandate2" role="tab" aria-controls="contact" aria-selected="false">Mandate2</a>
                     </li>
                  ...
                  <div class="tab-content mb-5" id="myTabContent">
                     <div class="tab-pane fade show active" id="mandate" role="tabpanel" aria-labelledby="profile-tab">
                        <div class="container-fluid">
                           <div class="row">
                              <div class="col-md-12 mb-5">
                                 ...
                                 if($editmode == 'no'){
                                 ?>
                                    <a href="<?php echo base_url('agent-profile'); ?>"><i class="fa fa-arrow-left mr-3"></i>Back to Profile</a>
                                 <?php
                                 } 
                                 ?>
                              </div>
                              ...
                              <?php  
                                ...
                                <?php
                                    ...
                                    if($mandate_histry_agent->_Term_contract!='' ){
                                      ?>
                                      <div class="col-md-4">
                                         <label>Term of Contract with club:</label>
                                         <p><?php echo $mandate_histry_agent->_Term_contract; ?></p>
                                       </div>
                                      <?php
                                    }
                                ...
                                <form id="mandate_form" method="post" action="<?php echo base_url('Myprofile/add_mandate'); ?>" class="needs-validation">
                                 ...
                                 <div class="form-row">
                                    <div class="col-md-4 mb-3">
                                       <label for="validationCustom01">Territory or sports clubs</label>
                                       <select name="territory" class="custom-select" required <?php echo $readonly; ?>>
                                          <option value="worldwide" <?php if(isset($mandate_check) AND $mandate_check->_Territory == 'worldwide' ){ echo "SELECTED"; } ?>>Worldwide </option>
                                          <option value="territory" <?php if(isset($mandate_check) AND $mandate_check->_Territory == 'territory' ){ echo "SELECTED"; } ?>>Territory </option>
                                          <option value="club/clubs" <?php if(isset($mandate_check) AND $mandate_check->_Territory == 'club/clubs' ){ echo "SELECTED"; } ?>>Club/clubs </option>
                                       </select>
                                      
                                    </div>
                                    <div class="col-md-4 mb-3">
                                       <label for="">Term of the Athlete's Mandate</label>
                                       <input type="text" class="form-control" name="term_athlete" id="" required <?php echo $readonly; ?> value="<?php echo isset($mandate_check)?$mandate_check->_Term_athlete:""; ?>">
                                    ...
                                    <div class="col-md-4 mb-3">
                                       ...
                                       <select name="contract_type" class="custom-select" required <?php echo $readonly; ?>>
                                    ...
                                    <div class="col-md-4 mb-3">
                                       <label for="termcontrct">Term of Contract with club</label> 
                                       <input type="text" name="term_contract" class="form-control" <?php echo $readonly; ?> value="<?php echo isset($mandate_check)?$mandate_check->_Term_contract:"";  ?>"/>
                                       <div class="valid-feedback" >
                                          Looks good!
                                       </div>
                                    </div>
                                    <div class="col-md-4 mb-3">
                                       <label for="">Expected Salary/ budget available</label>
                                       <input type="text" name="expected_salary" class="form-control" id="" required <?php echo $readonly; ?> value="<?php echo isset($mandate_check)?$mandate_check->_Expected_salary:""; ?>">
                                       <div class="valid-feedback">
                                          Looks good!
                                       </div>
                                    </div>
                                    <div class="col-md-4 mb-3">
                                       ...
                                       <input type="text" name="transfer_fee" class="form-control" <?php echo $readonly; ?> value="<?php echo isset($mandate_check)?$mandate_check->_Transfer_fee:""; ?>">
                                       <!-- <div class="valid-feedback">
                                          Looks good!
                                       </div> -->
                                    </div>
                                    <div class="col-md-4 mb-3">
                                       ...
                                       <input type="text" name="agency_fee" class="form-control" id="agencyfee"  required <?php echo $readonly; ?> value="<?php echo isset($mandate_check)?$mandate_check->_Agency_fee:""; ?>">
                                       <div class="valid-feedback">
                                          Looks good!
                                       </div>
                                    </div>
                                    <div class="col-md-4 mb-3">
                                       <label for="">Contract Extension Fee</label>
                                       <input type="text" name="extension_fee" class="form-control" id="" required <?php echo $readonly; ?> value="<?php echo isset($mandate_check)?$mandate_check->_Extension_fee:""; ?>">
                                       <div class="valid-feedback">
                                          Looks good!
                                       </div>
                                    </div>
                                    <div class="col-md-4 mb-3">
                                       <label for="">Flights</label>
                                        <select name="flights" class="custom-select" required <?php echo $readonly; ?>>
                                    ...
                                    <div class="col-md-4 mb-3">
                                       <label for="validationCustom01">Accommodation</label>
                                       <select name="accommodation" class="custom-select" required <?php echo $readonly; ?>>
                                    ...
                                    <div class="col-md-4 mb-3">
                                       ...
                                       <select name="try_out" class="custom-select" required <?php echo $readonly; ?> >
                                          <option value="Yes" <?php if(isset($mandate_check) AND $mandate_check->_Try_out == 'Yes' ){ echo "selected"; } ?>>Yes </option>
                                          <option value="No" <?php if(isset($mandate_check) AND $mandate_check->_Try_out == 'No' ){ echo "selected"; } ?>>No</option>
                                       </select>
                                    </div>
                                    <div class="col-md-4 mb-3">
                                       <label for="">Try Out Term</label>
                                       <input type="text" name="try_outteam" class="form-control" id="" required <?php echo $readonly; ?> value="<?php echo isset($mandate_check)?$mandate_check->_Try_outteam:""; ?>">
                                       <div class="valid-feedback">
                                          Looks good!
                                       </div>
                                    </div>
                                    <div class="col-md-4 mb-3">
                                       <label for="validationCustom01">Sign-on Fee</label>
                                       <select name="signon_fee" class="custom-select" required <?php echo $readonly; ?>>
                                          <option value="Yes" <?php if(isset($mandate_check) AND $mandate_check->_Signon_fee == 'Yes' ){ echo "selected"; } ?>>Yes </option>
                                          <option value="No" <?php if(isset($mandate_check) AND $mandate_check->_Signon_fee == 'No' ){ echo "selected"; } ?>>No</option>
                                       </select>
                                    </div>
                                    <div class="col-md-4 mb-3">
                                    ...
                                    <div class="col-md-4 mb-3">
                                       ...
                                       <input type="text" name="club_termination" class="form-control" id="" required <?php echo $readonly; ?> value="<?php echo isset($mandate_check)?$mandate_check->_Club_termination:""; ?>">
                                       <div class="valid-feedback">
                                          Looks good!
                                       </div>
                                    </div>
                                 ...
                                 // if(isset($mandate_check) AND $mandate_check->_Update_by=='0'){
                                 ...
                                 //       }
                                 // }
                                 // else if(isset($mandate_check) AND $mandate_check->_Update_by=='1'){
                                 ...
                                 /*if($this->session->userdata('usertype') == '2' AND empty($mandate_check)){
                                    ?>
                                       <input type="submit" name="btn_mandate" class="attributebtn" value="submit" />
                                    <?php
                                 }*/
                                       ...
                                       <form action="<?php echo base_url() ?>myprofile/accept_mandate" method="post">
                                           ...
                                           <input type="hidden" name="histryid" value="<?php echo isset($mandate_histry)?$mandate_histry->_Histry_ID:''; ?>" />
                                             ...
                                             <?php } ?>
                                                         ...
                                                         <button class="attributebtn" data-toggle="modal" data-target="#mandatepopup" onclick="return false;">Negotiations</button>
                                       </form>
                                <?php } ?>
                        ...
                        <div class="tab-pane fade" id="mandate2" role="tabpanel" aria-labelledby="profile-tab">
                        <div class="container-fluid">
                     ...
                     <center><p class="info-text">Accepted Mandates</p></center>
                      <table class="table table-striped">
                         <thead>
                            <tbody>
                               <tr>
                                  <th>Territory or sports clubs</th>
                                  <th>Term of the Athlete's Mandate</th>
                                  <th>Contract type</th>
                                  <th>Agency Fee</th>
                                  <th>Transfer Fee</th>
                               </tr>
                               ...
                               foreach ($accepted as $acc) {
                                 ?>
                                 <tr>
                                    <td><?php echo $acc->_Territory; ?></td>
                                    <td><?php echo $acc->_Term_athlete; ?></td>
                                    <td><?php echo $acc->_Contract_type; ?></td>
                                    <td><?php echo $acc->_Transfer_fee; ?></td>
                                    <td><?php echo $acc->_Agency_fee; ?></td>
                                 </tr>
                                 <?php
                               } 
                              }else{
                      ...
                      <center><p class="info-text">Rejected Mandates</p></center>
                      <table class="table table-striped">
                         <thead>
                            <tbody>
                               <tr>
                               ...
                               foreach ($rejected as $rej) {
                                 ?>
                                 <tr>
                                    <td><?php echo $rej->_Territory; ?></td>
                                    <td><?php echo $rej->_Term_athlete; ?></td>
                                    <td><?php echo $rej->_Contract_type; ?></td>
                                    <td><?php echo $rej->_Transfer_fee; ?></td>
                                    <td><?php echo $rej->_Agency_fee; ?></td>
                                 </tr>
                                 <?php
                               }
                              }else{
                                     ...
                                     <a class="nav-link" id="profile-tab" data-toggle="tab" href="#profile" role="tab" aria-controls="profile" aria-selected="false">Hirer</a>
                                        ...
                                        <div class="tab-content" id="myTabContent">
                                            <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
                                                <h3 class="register-heading">Mandate Form</h3>
                                           ...
                                           <div class="row">
                                                 ...
                                                 <div class="form-row">
                                                   <div class="col-md-4 mb-3">
                                                      ...
                                                      <select class="custom-select" required>
                                                        ...
                                                        <option value="SQ">Territory </option>
                                                        <option value="AR">Club </option>
                                                      </select>
                                                     
                                                   </div>
                                                   <div class="col-md-4 mb-3">
                                                      <label for="validationCustom01">Select Territory</label>
                                                      <select class="custom-select" required>
                                                   ...
                                                   <div class="col-md-4 mb-3">
                                                      <label for="validationCustom02">Term of the Athlete's Mandate</label>
                                                   ...
                                                   <div class="col-md-4 mb-3">
                                                      <label for="validationCustom02">Contract type </label>
                                                      <select class="custom-select" required>
                                                        <option value="AF">Professional </option>
                                                        <option value="SQ">amateur </option>
                                                      </select>
                                                   </div>
                                                   <div class="col-md-4 mb-3">
                                                       <label class="" for="inlineFormInputGroup">Expected salary</label>
                                                   ...
                                                   <div class="col-md-4 mb-3">
                                                      <label for="validationCustom02">monthly salary</label>
                                                      <input type="text" class="form-control" id="validationCustom02"   required>
                                                      <div class="valid-feedback">
                                                        Looks good!
                                                      </div>
                                                   ...
                                                   <div class="col-md-4 mb-3">
                                                      ...
                                                      <div class="col-md-4 mb-3">
                                                       <label class="" for="inlineFormInputGroup">Sign on fee Type Amount</label>
                                                         <div class="input-group mb-2 mr-sm-2 mb-sm-0">
                                                           <div class="input-group-addon currency-symbol">$</div>
                                                           <input type="text" class="form-control currency-amount" id="inlineFormInputGroup" placeholder="0.00" size="8">
                                                           <div class="input-group-addon currency-addon">
                                                   ...
                                                   <div class="col-md-4 mb-3">
                                                      <label for="validationCustom02">Term of Contract</label>
                                                       <div class="input-group term-of-contract">
                                                      <select id="Term_of_Contract" class="custom-select" required>
                                                        <option value="1to20">1 - 20 </option>
                                                        <option value="20to30">20 - 30</option>
                                                        <option value="30to40">30 - 40</option>
                                                        <option value="4to50">40 - 50</option>
                                                        <option value="5to60">50 - 60</option>
                                                      </select>
                                                   ...
                                                   <div class="col-md-4 mb-3">
                                                      <label for="validationCustom01">Agency fee %</label>
                                                   ...
                                                   <div class="col-md-4 mb-3">
                                                      <label for="validationCustom02">Contract Extension Fee</label>
                                                      <input type="text" class="form-control" id="validationCustom02"   required>
                                                      <div class="valid-feedback">
                                                        Looks good!
                                                      </div>
                                                   ...
                                                   <div class="col-md-4 mb-3">
                                                      ...
                                                      <select class="custom-select" required>
                                                        <option value="AF">one way </option>
                                                        <option value="SQ">2 ways </option>
                                                        <option value="AR">reimbursed upon signing contract</option>
                                                        <option value="AR"> not covered</option>
                                                        <option value="AR"> custom</option>
                                                      </select>
                                                   </div>
                                                   <div class="col-md-4 mb-3">
                                                      <label for="validationCustom01">Accommodation</label>
                                                   ...
                                                   <div class="col-md-4 mb-3">
                                                      <label for="validationCustom02">Try Out</label>
                                                      <select class="custom-select" required>
                                                        <option value="AF">Yes </option>
                                                        <option value="SQ">No</option>
                                                      </select>
                                                   </div>
                                                   <div class="col-md-4 mb-3">
                                                      <label for="validationCustom02">Try Out Term</label>
                                                      <select class="custom-select" required>
                                                        <option value="AF">Yes </option>
                                                        <option value="SQ">No</option>
                                                      </select>
                                                   ...
                                                   <div class="col-md-4 mb-3">
                                                      <label for="validationCustom02">Agency fee</label>
                                                       <div class="input-group term-of-contract">
                                                      <select id="Agency_fee" class="custom-select" required>
                                                       <option val="0">0</option><option val="1">1</option><option val="2">2</option><option val="3">3</option><option val="4">4</option><option val="1">1</option><option val="5">5</option><option val="6">6</option><option val="7">7</option><option val="8">8</option><option val="9">9</option><option val="10">10</option><option val="11">11</option><option val="12">12</option><option val="13">13</option><option val="14">14</option><option val="15">15</option><option val="16">16</option><option val="17">17</option><option val="18">18</option><option val="19">19</option><option val="20">20</option><option val="21">21</option><option val="22">22</option><option val="23">23</option><option val="24">24</option><option val="25">25</option>
                                                      </select>
                                                   ...
                                                   <div class="col-md-4 mb-3">
                                                      <label for="validationCustom02">Extension fee</label>
                                                       <div class="input-group term-of-contract">
                                                      <select id="extension_fee" class="custom-select" required>
                                                       <option val="0">0</option><option val="1">1</option><option val="2">2</option><option val="3">3</option><option val="4">4</option><option val="1">1</option><option val="5">5</option><option val="6">6</option><option val="7">7</option><option val="8">8</option><option val="9">9</option><option val="10">10</option><option val="11">11</option><option val="12">12</option><option val="13">13</option><option val="14">14</option><option val="15">15</option><option val="16">16</option><option val="17">17</option><option val="18">18</option><option val="19">19</option><option val="20">20</option><option val="21">21</option><option val="22">22</option><option val="23">23</option><option val="24">24</option><option val="25">25</option>
                                                      </select>
                                                      <span class="input-group-addon currency-addon">%</span>
                                                      </div>
                                                   ...
                                                   <div class="col-md-4 ">
                                                   <label for="validationCustom02">Mandate term</label>
                                                      <div class="input-group">
                                                        <div class="input-group-prepend">
                                                         <span class="input-group-text"><i class="fa fa-calendar" aria-hidden="true"></i>
                                                </span>
                                                        </div>
                                                        <input class="form-control" id="datetimepicker" type="text" placeholder="Choose time">
                                                      </div>
                                                   </div>
                                                 </div>
                                               ...
                                               <button class="attributebtn">Accept </button>
                                                 ...
                                                 <button class="attributebtn" data-toggle="modal" data-target="#mandatepopup">Negotiations</button>
                                               </div>
                                             </div>
                                            ...
                                            <div class="tab-pane fade show" id="profile" role="tabpanel" aria-labelledby="profile-tab">
                                                ...
                                                <div class="row register-form">
                                                    ...
                                                    <div class="col-md-6">
                                                        ...
                                                        <input type="submit" class="btnRegister" value="To Club" />
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
